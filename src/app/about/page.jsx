      ...
      <section className='container mt-12'>
        <div>
          ...
          <div className='md:flex flex-row-reverse mt-12 items-center gap-5'>
            <p><span className='font-bold block mb-4 text-2xl'>The Gang-Shalik Experience</span>At Gang-Shalik, we believe that a meal is more than just food on a plate; its an experience that should be savored and shared. Our open-air dining area, surrounded by verdant gardens and the soothing sounds of nature, provides the perfect backdrop for memorable meals. Whether youre celebrating a special occasion or simply seeking a peaceful escape from the hustle and bustle of daily life, Gang-Shalik offers a sanctuary where you can indulge in the art of fine dining amidst the beauty of the natural world.</p>
